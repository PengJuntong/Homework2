...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator22 = ObjectAnimator.ofFloat(target,"scaleY",1f,2f);


        animator22.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator22.setRepeatCount(ObjectAnimator.INFINITE);
        animator22.setRepeatMode(ObjectAnimator.REVERSE);
